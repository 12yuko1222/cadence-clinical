...
* The backoff delay is calculated using a bounded exponential backoff formula:
  ...
  *(e.g., base delay = 10s, max delay = 300s, matching the notification dispatcher retry contract).*
