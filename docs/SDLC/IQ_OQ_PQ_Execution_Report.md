...
- **Total Automated Test Cases Run:** 1558
- **Passed:** 1449 🟢
- **Failed/Errors:** 109 🔴
- **Skipped:** 0 ⚪
- **Overall Operational Pass Rate:** 93.00%
...
| `test_cdisc_openapi_export_parity` | `tests.test_cdisc_openapi_contract` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_rules_auth_gateways` | `tests.test_designer_rules` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_gateway_semantic_action_issuance_and_enforcement` | `tests.test_gateway` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_proxy_requests_terminology_paths` | `tests.test_gateway` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_signature_gated_mutation_enforcement` | `tests.test_gateway` | Trace-15 | 🔴 FAILED | < 1s |
| `test_signature_gated_mutation_expired_token` | `tests.test_gateway` | Trace-15 | 🔴 FAILED | < 1s |
| `test_signature_gated_mutation_mismatched_action` | `tests.test_gateway` | Trace-15 | 🔴 FAILED | < 1s |
| `test_signature_token_altered_signature_rejected` | `tests.test_gateway` | Trace-15 | 🔴 FAILED | < 1s |
...
| `test_auth_and_malformed_requests` | `tests.test_global_library_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_sponsor_security_boundaries` | `tests.test_global_library_api` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_designer_gateway_auth_expired_timestamp` | `tests.test_main` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_designer_gateway_auth_invalid_signature` | `tests.test_main` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_designer_gateway_auth_invalid_timestamp` | `tests.test_main` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_designer_gateway_auth_missing_headers` | `tests.test_main` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_api_block_crud_with_rbac` | `tests.test_protocol_blocks` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_export_protocol_unauthenticated` | `tests.test_protocol_export` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_downstream_signature_gated_endpoint_expired_token` | `tests.test_security_middleware` | Trace-15 | 🔴 FAILED | < 1s |
| `test_downstream_signature_gated_endpoint_mismatched_action` | `tests.test_security_middleware` | Trace-15 | 🔴 FAILED | < 1s |
| `test_downstream_signature_gated_endpoint_replay_blocked` | `tests.test_security_middleware` | Trace-15 | 🔴 FAILED | < 1s |
| `test_downstream_signature_gated_endpoint_requires_sig_token` | `tests.test_security_middleware` | Trace-15 | 🔴 FAILED | < 1s |
| `test_downstream_signature_gated_endpoint_valid_sig_token` | `tests.test_security_middleware` | Trace-15 | 🟢 PASSED | < 1s |
| `test_middleware_cross_request_scope_isolation` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_expired_timestamp` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_explicit_legacy_version_accepted` | `tests.test_security_middleware` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_middleware_explicit_legacy_version_invalid_rejected` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_health_bypass` | `tests.test_security_middleware` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_middleware_invalid_timestamp_format` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_missing_headers` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_missing_signature_version_rejected` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_permissions_parsed_in_state` | `tests.test_security_middleware` | *Regression/Helper* | 🟢 PASSED | < 1s |
| `test_middleware_scope_header_mutation_and_injection_rejection` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_tenant_context_and_state` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_tenant_missing_fallback` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_tenant_signature_tampering_rejected` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_unblinded_access_edge_cases` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_middleware_unblinded_access_parametrization[1-True]` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_unblinded_access_parametrization[TRUE-True]` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_unblinded_access_parametrization[YeS-True]` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_middleware_unblinded_access_parametrization[true-True]` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_unblinded_access_parametrization[yes-True]` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_unsupported_version_rejected` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_v2_invalid_signature` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_v2_mismatched_reason` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
| `test_middleware_v2_missing_reason` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_mutation_unsigned_and_non_compliant_rejections` | `tests.test_security_middleware` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_verify_sig_token_helper_scenarios` | `tests.test_security_middleware` | Trace-15 | 🔴 FAILED | < 1s |
...
| `test_api_audit_reason_enforcement` | `tests.test_soa_endpoints` | *Regression/Helper* | 🔴 FAILED | < 1s |
...
| `test_api_unauthorized_requests` | `tests.test_soa_endpoints` | *Regression/Helper* | 🔴 FAILED | < 1s |
